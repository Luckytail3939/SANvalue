package com.luckytail3939.gmail.com.inmod.entity.model;
...
public class MoonSlimeModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SanityMod.MOD_ID, "moon_slime_layer"), "main");
	private final ModelPart root;

	public MoonSlimeModel(ModelPart root) {
