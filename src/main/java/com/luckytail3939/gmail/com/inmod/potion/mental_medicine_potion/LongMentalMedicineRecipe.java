...
public class LongMentalMedicineRecipe implements IBrewingRecipe {
    @Override
    ...
    public boolean isIngredient(ItemStack input) {
        return input.getItem() == Items.REDSTONE;
    }

    @Override
    public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
        if (isInput(input) && isIngredient(ingredient)) {
            return PotionUtils.setPotion(new ItemStack(Items.POTION), ModPotions.LONG_MENTAL_MEDICINE_POTION.get());
        }
